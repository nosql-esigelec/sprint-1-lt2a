...
@pytest.mark.template_service
def test_delete_private_template(template_service_instance, user_service_instance, user_id):
...
def test_star_template(template_service_instance, user_service_instance):
    ...
    template_id = template_service_instance.create_template(template_data).get("result").get("id")['template_id']
