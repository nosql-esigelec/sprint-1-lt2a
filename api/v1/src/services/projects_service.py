...
from api.v1.src.utils.handlers import generate_response
...
class ProjectService:
    """
    A class to manage project operations.

    Attributes:
        mongo (MongoDB): An instance of the MongoDB class.
        neo4j (Neo4jDB): An instance of the Neo4jDB class.
    """
...
class ProjectService:
    ...
    def select_template(self, project_id: str, template_id: str):
        ...
        project = self.mongo.read(
            query={"_id": project_id}, collection_name="projects"
        )
        if project is None:
